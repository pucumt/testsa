var login = require('./login.js'),
    ...
    publicSchool = require('./publicSchool.js'),
    publicGrade = require('./publicGrade.js'),
    cityArea = require('./cityArea.js'),
    publicSchoolGradeRelation = require('./publicSchoolGradeRelation.js'),
